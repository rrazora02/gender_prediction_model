...
# Initialize video capture or image
if args.image:
    # If image path is provided, read the image
    ...
    if not video.isOpened():
        print("Error: Could not open camera. No camera detected.")
        print("Please provide an image using: python detect.py --image <image_path>")
        exit()
...
if video is not None:
    ...
    if not faceBoxes:
        ...
        print(f"Found {len(faceBoxes)} face(s)")
